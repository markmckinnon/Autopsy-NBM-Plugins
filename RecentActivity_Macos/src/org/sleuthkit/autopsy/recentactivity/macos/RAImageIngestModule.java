...
public final class RAImageIngestModule implements DataSourceIngestModule {
    ...
    private static final String RECENT_ACTIVITY_FOLDER = "RecentActivity Macos";
    ...
    public void startUp(IngestJobContext context) throws IngestModuleException {
        ...
        Extract sqliteDatabases = new ParseSQLite(context);
        ...
        extractors.add(sqliteDatabases);
    ...
    public ProcessResult process(Content dataSource, DataSourceIngestModuleProgress progressBar) {
        ...
        for (int i = 0; i < extractors.size(); i++) {
            ...
            if (context.dataSourceIngestIsCancelled()) {
                logger.log(Level.INFO, "Recent Activity Macos has been canceled, quitting before {0}", extracter.getDisplayName()); //NON-NLS
                break;
            }
